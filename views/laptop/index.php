...
<section class="phone-info">
  <div class="container">
    <h2 hidden>Ремонт ноутбуков в сервисном центре Скайнет</h2>
  </div>
  <div class="container">
    <div class="section-banner">
      <div class="section-banner__info-wrapper">
        <h1 class="section-banner__h1">Ремонт ноутбуков</h1>
        <p class="section-banner__desc">Ремонт ноутбуков любой сложности в Скайнет.</p>
      </div>
      <img class="section-banner__img" src="../img/laptop-repair-hero.png" alt="Ремонт ноутбуков в сервисном центре Скайне">
    </div>
  </div>
