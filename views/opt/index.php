...
<section class="opt-hero">
  <div class="container">
    <div class="opt-hero__wrapper">
      <div class="opt-hero__content">
        <h1 class="hidden">Предложение для сервисных центров, оптовых покупателей, мастеров сервисных центров.</h1>
        <h1 class="hidden">Предложение для сервисных центров, оптовых покупателей, мастеров сервисных центров.</h1>
        <h2 class="title-h2 opt-hero__title">Для получения скидки зарегистрируйтесь как оптовик</h2>
        <span class="lineOne"></span>
        <p class="opt-hero__desc">Зарегистрируйтесь в нашем интернет-магазине, чтобы с удобством просматривать интересующий Вас товар и делать заказы.</p>
        <a href="https://shop.skynet-service.com/index.php?route=account/login" class="btn btn--blue opt-hero__reg-link">Зарегистрироваться</a>
        <a class="opt-hero__autorize-link" href="https://shop.skynet-service.com/index.php?route=account/login">Авторизоваться</a>
      </div>
      <div class="opt-hero__img-container">
        <img class="opt-hero__img" src="../img/opt-hero-bg.png" alt="Запчасти для смартфонов">
      </div>
    </div>
  </div>
</section>
<section class="opt-become">
  <div class="container">
    <h2 class="title-h2">
      Как покупать оптом в Скайнет
    </h2>
    <span class="lineOne"></span>
    <ul class="opt-become__list">
      <li class="opt-become__item opt-become__item-1">
        <h3 class="hidden">Первое условие</h3>
        <h4 class="title-h4 opt-become__item-title">Зарегистрируйтесь</h4>
        <p class="opt-become__item-desc">Создайте учётную запись или авторизуйтесь в нашем интернет-магазине.После регистрации наш менеджер свяжется с Вами и закрепит соответствующую ценовую категорию.</p>
      </li>
      <li class="opt-become__item opt-become__item-2">
        <h3 class="hidden">Второе условие</h3>
        <h4 class="title-h4 opt-become__item-title">Выберите товар</h4>
        <p class="opt-become__item-desc">Создайте учётную запись или авторизуйтесь в нашем интернет-магазине.После регистрации наш менеджер свяжется с Вами и закрепит соответствующую ценовую категорию.</p>
      </li>
      <li class="opt-become__item opt-become__item-3">
        <h3 class="hidden">Третье условие</h3>
        <h4 class="title-h4 opt-become__item-title">Закажите на сайте</h4>
        <p class="opt-become__item-desc">Создайте учётную запись или авторизуйтесь в нашем интернет-магазине.После регистрации наш менеджер свяжется с Вами и закрепит соответствующую ценовую категорию.</p>
      </li>
      <li class="opt-become__item opt-become__item-4">
        <h3 class="hidden">Четвертое условие</h3>
        <h4 class="title-h4 opt-become__item-title">Расскажите друзьям</h4>
        <p class="opt-become__item-desc">Создайте учётную запись или авторизуйтесь в нашем интернет-магазине.После регистрации наш менеджер свяжется с Вами и закрепит соответствующую ценовую категорию.</p>
      </li>
...
<section class="product-opt">
  <div class="container">
    ...
    <!-- lcd -->
    <div class="product-opt__item-wrap">
      <h2 class="title-h2">
        Дисплеи для iPhone
      </h2>
      <span class="lineOne"></span>
      <ul class="our-prices__list-opt">
        <?php
        require '../config/opt_product_lcd.php';
        ?>
      </ul>
      <div class="product__btn-more-container">
        <button class="btn product__btn-more all-opt-lcd" data-show="true">Показать ещё</button>
      </div>
    </div>
    ...
    <div class="product-opt__item-wrap">
      <h2 class="title-h2">
        Аккумуляторы для iPhone и проклейки оптом
      </h2>
      <span class="lineOne"></span>
      <ul class="our-prices__list-opt">
        <?php
        require '../config/opt_product_akb.php';
        ?>
      </ul>
      <div class="product__btn-more-container">
        <button class="btn product__btn-more all-opt-akb" data-show="true">Показать ещё</button>
      </div>
    </div>
  </div>
</section>
