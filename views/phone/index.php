...
<!-- repair phone hero -->
<section class="phone-info-hero">
  <div class="container">

    <div class="section-banner">
      <div class="section-banner__info-wrapper">
        <h1 class="section-banner__h1">Ремонт телефонов от 15 минут</h1>
        <p class="section-banner__desc">Бесплатная диагностика любого оборудования, высокое качество запчастей и большая гарантия.</p>
      </div>

      <img class="section-banner__img" src="/img/iphone-11-1-1.png" alt="Ремонт телефонов от 15 минут">
    </div>
  </div>
</section>
<!-- repair phone info -->
<section class="phone-info">
  <div class="container">
    <h2 class="info-title">Часто задаваемые вопросы:</h2>
  </div>
