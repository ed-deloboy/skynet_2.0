...
<section class="contacts-info">
  <div class="container">
    <div class="contacts-info__wrapper">
      <h2 hidden class="title-h2">Контакты компании Скайнет и информация о компании</h2>
      <h3 class="contacts-info__title title-h2">
        Компания Скайнет Сервис
      </h3>
      <div class="contacts-info__desc">
        <span>У нас вы найдёте только качественные, оригинальные запчасти для ремонта техники Apple. Работая с нами Вы исключаете риски с большим процентом брака, так как каждая запчасть проверена на нашем складе, для того чтобы наши покупатели оставались довольны
          и обращались к нам снова. Компания Скайнет – Ваш лучший выбор.</span>
        <a href="#" class="contacts-info__img">
          <img src="../img/apple_card_and__technics.jpg" alt="" class="contacts-info__img--link">
        </a>
      </div>
    </div>
