...
<head>
	...
	<title>Личный кабинет Скайнет</title>
	<!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="./images/favicon.png">
	<link href="asset_office/vendor/jqvmap/css/jqvmap.min.css" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
	<div id="main-wrapper">
        ...
        ***********************************-->
		<div class="nav-header">
			<a href="/" class="brand-logo">
				<img class="logo-abbr" src="../img/preload.svg" alt="">
				<img class="brand-title" src="../img/logo-text.svg" alt="">
			</a>
									...
									<div class="header-info">
										<span>Привет, <strong>
												...
												if ($user['first_name'] == '') {
													...
													echo mb_convert_case($user['first_name'], MB_CASE_TITLE, "UTF-8");
												}
												?>
											</strong>
										</span>
		...
		<div class="deznav">
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					<!-- data-id-page="home" class="sidebar-list btns_pages" -->
					<li data-id-page="home" style="cursor: pointer;" class="btns_pages cursor-pointer">
						<a class="ai-icon" aria-expanded="false">
							<i class="fas fa-home"></i>
							<span class="nav-text">Главная</span>
						</a>
					</li>
					<li data-id-page="cartPage" style="cursor: pointer;" class="btns_pages cursor-pointer">
					...
					if ($user['role'] > 3) {
					?>
						<li><a class="has-arrow ai-icon text-dark" href="javascript:void()" aria-expanded="false">
        ...
        ***********************************-->
		<div class="footer">
			<div class="copyright">
				<p>Скайнет Сервис © Разработка <a href="https://vk.com/deloboy_live" target="_blank">UI Code</a></p>
			</div>
		</div>
		<!--**********************************
            Footer end
    ...
    ***********************************-->
	<!-- Required vendors -->
	<script src="asset_office/vendor/global/global.min.js"></script>
	<script src="asset_office/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
	...
	<script src="asset_office/vendor/jquery.counterup/jquery.counterup.min.js"></script>

	<!-- Apex Chart -->
	<script src="asset_office/vendor/apexchart/apexchart.js"></script>

	<!-- Chart piety plugin files -->
	<script src="asset_office/vendor/peity/jquery.peity.min.js"></script>

	<!-- Dashboard 1 -->
	<script src="asset_office/js/dashboard/dashboard-1.js"></script>
