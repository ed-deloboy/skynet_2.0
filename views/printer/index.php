...
<section class="phone-info">
  <div class="container">
    <h2 hidden class="info-title">Ремонт принтеров в Скайнет</h2>
  </div>
  <div class="container">
    <div class="section-banner">
      <div class="section-banner__info-wrapper">
        <h1 class="section-banner__h1">Ремонт принтеров</h1>
        <p class="section-banner__desc">Ремонт принтеров любой сложности в Скайнет.</p>
      </div>
      <img class="section-banner__img" src="../img/printer-repair-hero.png" alt="Ремонт принтеров в Скайнет">
    </div>
  </div>
