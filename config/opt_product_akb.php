<!-- https://skynet-service.com/price/opt-akb.csv -->

<?php

$optAkbProduct = "https://skynet-service.com/price/opt-akb.csv";

$num2 = 0;
if (($handle = fopen($optAkbProduct, "r")) !== FALSE) {
    ...
    $discountoptM = 3;
      ...
      $discountoptM = 2;
        ...
        if($num2 > 1 and $num2 < 18){
         ?>
<li class="product__item product__item-opt--akb product__item--hidden-akb--opt">
